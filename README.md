...
_promptrunner_ is a tiny wrapper API built for running inference on LLMs --- both locally and via 
providers. It is built on top of [LiteLLM](https://github.com/BerriAI/litellm),
